...
public class FavoriteDataList extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initData(){
        saveDataManager = SaveDataManager.getInstance(FavoriteDataList.this);
    ...
    private void getNetworkData(Context context,String token){
        ...
        progressDialog.show();
      String url =   URLConstant.FAVORITE_LIST_URL+token;
            ...
            public void successResponse(JSONObject response) {
               ...
               if(categoryArticleData!=null&& categoryArticleData.getArticaleDataArrayList().size()>0){
                  ...
                  // Log.e("===!!!!=======", " "+mCategoryList.getmCategoryArticleData().getArticaleDataArrayList().get(0).getTitle());
                   ...
                   Toast.makeText(FavoriteDataList.this, "Sorry. No data found !.", Toast.LENGTH_SHORT).show();
                   finish();
               }
            }
